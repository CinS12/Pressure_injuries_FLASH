...
class Pressure_img:
    ...
    def roi_crop(self, im, tissue):
        ...
        def roi(img, vertices):
            ...
            pub.sendMessage("ASK_ROI_CONFIRMATION", img_cv2_mask=img, img_cv2_roi=masked, tissue=tissue, scale_factor=100)
